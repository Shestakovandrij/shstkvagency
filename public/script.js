...
(function () {
  ...
  var I18N = {
    uk: {
      ...
      "why.5.d": "Створюємо AI-рішення й Telegram-ботів, які працюють 24/7: відповідають клієнтам, обробляють заявки, автоматизують бізнес-процеси та інтегруються з CRM і вашими сервісами",
      ...
      "why.5.k1": "AI", "why.5.k2": "Telegram-боти", "why.5.k3": "CRM", "why.5.k4": "Інтеграції",
      ...
      "budget.plan2.f1": "Усе з тарифу €300",
      ...
      "service.2.d": "Розробляємо масштабовані інтернет-магазини будь-якої складності - від невеликих каталогів до великих eCommerce-платформ із CRM, платіжними системами, службами доставки, автоматизацією та індивідуальними інтеграціями",
      ...
      "cases.tab.budget": "Сайти від €300",
      ...
      "case.10.meta": "Лендинг • Сонячні панелі",
      "case.11.meta": "Лендинг • Декоративні панелі",
      "case.12.meta": "Лендинг • Курси відеомонтажу",
      "case.13.meta": "Багатосторінковий • Бухгалтерія",
      "case.14.meta": "Інтернет-магазин • Свічки",
      "case.15.meta": "Лендинг • Ремонти",
      "case.16.meta": "Лендинг • Клінінг",
      "case.17.meta": "Лендинг • Меблі та інтер'єри",
      "case.18.meta": "Лендинг • Електромонтаж",
      "case.19.meta": "Лендинг • Консалтинг",
      "case.20.meta": "Лендинг • Ремонти",
      "case.21.meta": "Інтернет-магазин • Б'юті-техніка",
      "case.22.meta": "Лендинг • Сонячні електростанції",
      "case.23.meta": "Лендинг • Логістика",
      "case.24.meta": "Лендинг • Побутова хімія",
      "case.25.meta": "Лендинг • Монтаж меблів і кухонь",
      "case.26.meta": "Лендинг • Діодні лазери",
      "case.27.meta": "Лендинг • Продаж авто",
      "case.28.meta": "Лендинг • Запчастини для гібридів",
      "case.29.meta": "Інтернет-магазин • Квіти",
      "case.30.meta": "Багатосторінковий • Консалтинг",
      "case.31.meta": "Багатосторінковий • Барбершопи",
      "case.32.meta": "Лендинг • Обслуговування нерухомості",
      "case.33.meta": "Лендинг • Автокосметика",
      "case.34.meta": "Лендинг • Відбілювання зубів",
      "case.35.meta": "Багатосторінковий • Будівництво",
      "case.1.tag": "Лендинг",
      ...
      "faq.2.a": "Так. Ми комплексно супроводжуємо проєкт: від розробки брендингу та дизайну до створення сайту, SEO-просування, налаштування реклами, AI-автоматизації та подальшої підтримки. Ви отримуєте готову систему для залучення клієнтів і розвитку бізнесу",
      ...
      "faq.4.a": "Так. Створюємо інтернет-магазини будь-якої складності з каталогом товарів, онлайн-оплатою, інтеграцією CRM, служб доставки, платіжних систем та будь-яких необхідних сервісів. Повністю адаптуємо під мобільні пристрої та подальше масштабування",
      "faq.5.q": "Чи займаєтесь SEO-просуванням?",
      "faq.5.a": "Так. Ми комплексно займаємося SEO-просуванням: аудит, стратегія, внутрішня та зовнішня оптимізація, контент і постійна робота над зростанням позицій сайту в Google та органічного трафіку",
      ...
      "faq.7.a": "Залиште заявку на сайті - ми зв'яжемося з вами протягом 24 годин, обговоримо ваш проєкт і запропонуємо оптимальне рішення, або напишіть нам у Telegram чи Instagram, якщо вам зручніше спілкуватися там",
      ...
      "form.agree": "Я ознайомився/-лася з Політикою конфіденційності та погоджуюся на обробку моїх даних для опрацювання заявки",
    ...
    pl: {
      ...
      "why.5.d": "Tworzymy rozwiązania AI i boty Telegram, które działają 24/7: odpowiadają klientom, obsługują zgłoszenia, automatyzują procesy biznesowe oraz integrują się z CRM i Twoimi usługami",
      ...
      "why.5.k1": "AI", "why.5.k2": "Boty Telegram", "why.5.k3": "CRM", "why.5.k4": "Integracje",
      ...
      "budget.plan2.f1": "Wszystko z taryfy €300",
      ...
      "service.2.d": "Tworzymy skalowalne sklepy internetowe o dowolnej złożoności - od niewielkich katalogów po duże platformy eCommerce z CRM, systemami płatności, firmami kurierskimi, automatyzacją i indywidualnymi integracjami",
      ...
      "cases.tab.budget": "Strony od €300",
      ...
      "case.10.meta": "Landing page • Panele słoneczne",
      "case.11.meta": "Landing page • Panele dekoracyjne",
      "case.12.meta": "Landing page • Kursy montażu wideo",
      "case.13.meta": "Strona wielostronicowa • Księgowość",
      "case.14.meta": "Sklep internetowy • Świece",
      "case.15.meta": "Landing page • Remonty",
      "case.16.meta": "Landing page • Sprzątanie",
      "case.17.meta": "Landing page • Meble i wnętrza",
      "case.18.meta": "Landing page • Instalacje elektryczne",
      "case.19.meta": "Landing page • Doradztwo",
      "case.20.meta": "Landing page • Remonty",
      "case.21.meta": "Sklep internetowy • Technika kosmetyczna",
      "case.22.meta": "Landing page • Elektrownie słoneczne",
      "case.23.meta": "Landing page • Logistyka",
      "case.24.meta": "Landing page • Chemia gospodarcza",
      "case.25.meta": "Landing page • Montaż mebli i kuchni",
      "case.26.meta": "Landing page • Lasery diodowe",
      ...
      "case.30.meta": "Strona wielostronicowa • Konsulting",
      "case.31.meta": "Strona wielostronicowa • Barbershopy",
      "case.32.meta": "Landing page • Obsługa nieruchomości",
      "case.33.meta": "Landing page • Kosmetyka samochodowa",
      "case.34.meta": "Landing page • Wybielanie zębów",
      "case.35.meta": "Strona wielostronicowa • Budownictwo",
      ...
      "faq.2.a": "Tak. Kompleksowo prowadzimy projekt: od opracowania brandingu i designu, przez stworzenie strony, pozycjonowanie SEO, konfigurację reklam, automatyzację AI, aż po dalsze wsparcie. Otrzymujesz gotowy system do pozyskiwania klientów i rozwoju biznesu.",
      ...
      "faq.4.a": "Tak. Tworzymy sklepy internetowe o dowolnej złożoności z katalogiem produktów, płatnościami online, integracją CRM, firm kurierskich, systemów płatności oraz dowolnych potrzebnych usług. W pełni dostosowujemy do urządzeń mobilnych i dalszego skalowania.",
      "faq.5.q": "Czy zajmujecie się pozycjonowaniem SEO?",
      "faq.5.a": "Tak. Kompleksowo zajmujemy się pozycjonowaniem SEO: audyt, strategia, optymalizacja wewnętrzna i zewnętrzna, treści oraz stała praca nad wzrostem pozycji strony w Google i ruchu organicznego.",
      ...
      "faq.7.a": "Zostaw zgłoszenie na stronie - skontaktujemy się z Tobą w ciągu 24 godzin, omówimy Twój projekt i zaproponujemy optymalne rozwiązanie, lub napisz do nas na Telegramie czy Instagramie, jeśli wolisz tam rozmawiać.",
      ...
      "form.agree": "Zapoznałem/-am się z Polityką prywatności i wyrażam zgodę na przetwarzanie moich danych w celu rozpatrzenia zgłoszenia",
  ...
  /* Кожна мова має власний URL (/ і /pl/): мову сторінки задає <html lang>,
  ...
  function initLangSwitch() {
    var pageLang = document.documentElement.getAttribute("lang") === "pl" ? "pl" : "uk";
    ...
    applyLang(pageLang);
    initLangHint(pageLang);
  }

  /* Підказка мови: якщо браузер польський, а відкрита українська сторінка
     (або навпаки) — пропонуємо перейти. Без автоперенаправлення: українці
     в Польщі часто мають польську IP, але читають українською. */
  var HINT_KEY = "ws-lang-hint";
  var HINT_TEXT = {
    pl: { text: "Wygląda na to, że mówisz po polsku.", go: "Wersja polska", stay: "Zostań" },
    uk: { text: "Схоже, вам зручніше українською.", go: "Українська версія", stay: "Залишитись" }
  };

  function browserLang() {
    var list = navigator.languages && navigator.languages.length ? navigator.languages : [navigator.language || ""];
    var first = String(list[0] || "").toLowerCase();
    if (first.indexOf("pl") === 0) return "pl";
    if (first.indexOf("uk") === 0 || first.indexOf("ru") === 0) return "uk";
    return null;
  }

  function initLangHint(pageLang) {
    try {
      if (localStorage.getItem(STORE_KEY) || localStorage.getItem(HINT_KEY)) return;
    } catch (e) { return; }
    var want = browserLang();
    if (!want || want === pageLang || !altUrl(want)) return;

    var copy = HINT_TEXT[want];
    var box = document.createElement("div");
    box.className = "lang-hint";
    box.setAttribute("role", "dialog");
    box.setAttribute("lang", want);
    box.innerHTML =
      '<span class="lang-hint__text"></span>' +
      '<button type="button" class="lang-hint__go"></button>' +
      '<button type="button" class="lang-hint__stay"></button>';
    ...
    box.querySelector(".lang-hint__go").addEventListener("click", function () { close(); goToLang(want); });
    box.querySelector(".lang-hint__stay").addEventListener("click", function () {
      try { localStorage.setItem(STORE_KEY, pageLang); } catch (e) {}
      close();
    });

    document.body.appendChild(box);
    window.setTimeout(function () { box.classList.add("is-visible"); }, 1200);
  }
