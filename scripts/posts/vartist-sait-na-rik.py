...
# Ціни третіх сторін — орієнтовні діапазони станом на вересень 2026 (перевірено: OVH/home.pl/nazwa.pl, Verisign .com,
# Hostinger, Webflow site plans після оновлення травня 2026, Google Workspace).

POST = {"key": "vartist-sait-na-rik",
 "path_uk": "/blog/skilky-koshtuie-sait-na-rik/",
 "path_pl": "/pl/blog/ile-kosztuje-strona-internetowa-na-rok/",
 "img": "assets/why-5.webp",
 "title_uk": "Скільки коштує сайт на рік: домен, хостинг, підтримка",
 "title_pl": "Ile kosztuje strona internetowa na rok? Domena i hosting",
 "desc_uk": "Скільки коштує домен, хостинг, пошта й підтримка сайту на рік. Таблиця витрат для лендінгу, візитки й магазину, .pl чи .com, пастки з продовженням і як зекономити.",
 "desc_pl": "Ile kosztuje domena, hosting, poczta i opieka nad stroną na rok. Tabela kosztów dla landingu, wizytówki i sklepu, domena .pl czy .com, pułapki przy odnowieniu.",
 ...
 "sections": [{"h2_uk": "З чого складаються щорічні витрати на сайт",
               ...
               "blocks": [("p",
                           "Щорічні витрати на сайт — це все, що треба оплачувати, щоб він просто працював: домен, хостинг, SSL-сертифікат, корпоративна пошта, платні плагіни або план "
                           "конструктора, а також технічна підтримка. Окремо, за бажанням, ідуть контент і SEO. Розробку ви оплачуєте один раз, ці пункти — регулярно.",
                           "Roczne koszty strony to wszystko, za co trzeba płacić, żeby po prostu działała: domena, hosting, certyfikat SSL, poczta firmowa, płatne wtyczki albo plan "
                           "kreatora oraz opieka techniczna. Osobno, jeśli chcesz, dochodzą treści i SEO. Za wykonanie strony płacisz raz, za te pozycje — regularnie."),
                          ("p",
                          ...
                          ("ul",
                           [("<b>домен</b> — адреса сайту, оплачується щороку в реєстратора;", "<b>domena</b> — adres strony, opłacana co roku u rejestratora;"),
                            ...
                            ("<b>SSL-сертифікат</b> — замочок і https у браузері;", "<b>certyfikat SSL</b> — kłódka i https w przeglądarce;"),
                            ("<b>пошта на домені</b> — адреси виду office@вашдомен;", "<b>poczta firmowa</b> — adresy typu biuro@twojadomena.pl;"),
               ...
               "blocks": [("p",
                          ...
                          ("table",
                           ...
                           [[(".pl", ".pl"), ("Бізнес, що працює з клієнтами в Польщі", "Firmy działające na polskim rynku"),
                             ("≈ €15–45 / рік, у різних реєстраторів ціна відрізняється в рази", "≈ 60–200 zł / rok, u różnych rejestratorów ceny różnią się kilkukrotnie")],
                            [(".com", ".com"), ("Міжнародна аудиторія, кілька країн", "Klienci z wielu krajów, rynek międzynarodowy"),
                             ("≈ €10–20 / рік; оптова ціна зони зростає з листопада 2026", "≈ 10–20 € / rok; cena hurtowa .com rośnie od listopada 2026")],
                            [(".com.ua", ".com.ua"), ("Бізнес, орієнтований на Україну", "Firmy nastawione na rynek ukraiński"), ("≈ 200–700 грн / рік", "≈ 200–700 UAH / rok")]]),
                          ("p",
                           "Як обрати: якщо клієнти в Польщі, беріть .pl — поляки звикли до цієї зони, а Google краще розуміє, для якої країни сайт. Якщо працюєте на кілька країн, логічніше .com. "
                           "Для українського ринку — .com.ua або .ua. Коли назва важлива для бренду, має сенс одразу зареєструвати обидві зони, .pl і .com, і налаштувати переадресацію на основну.",
                           "Jak wybrać: jeśli klienci są w Polsce, bierz .pl — Polacy są do tej końcówki przyzwyczajeni, a Google łatwiej rozumie, do jakiego kraju kierowana jest strona. "
                           "Jeśli działasz w kilku krajach, bardziej logiczna jest domena .com. Gdy nazwa jest ważna dla marki, warto od razu zarejestrować obie, .pl i .com, i ustawić "
                           "przekierowanie na główną. Tak odpowiadamy na częste pytanie „domena pl czy com”: liczy się rynek, a nie końcówka sama w sobie."),
                          ("p",
                           "Наприклад, <a href=\"case-elart-cleaning\">лендінг Elart Cleaning</a> працює для клієнтів у Познані, тому стоїть на домені .pl.",
                           "Na przykład <a href=\"case-elart-cleaning\">landing page Elart Cleaning</a> jest skierowany do klientów z Poznania, dlatego działa na domenie .pl. Popularni "
                           "rejestratorzy w Polsce to m.in. OVH, home.pl i nazwa.pl — przed zakupem porównaj u nich cenę odnowienia, a nie tylko pierwszego roku.")]},
              {"h2_uk": "Хостинг, SSL і пошта: скільки платити за роботу сайту",
               "h2_pl": "Hosting, SSL i poczta: ile płacisz za działanie strony",
               "blocks": [("p",
                           "Хостинг для невеликого сайту коштує орієнтовно €40–200 на рік, для магазину — €100–400 і більше (станом на 2026, перевіряйте в провайдера). SSL-сертифікат для "
                           "звичайного сайту зазвичай безкоштовний і входить у хостинг. Пошта на домені — від нуля, якщо скриньки є в хостингу, до кількох євро на місяць за користувача.",
                           "Hosting dla małej strony kosztuje orientacyjnie 40–200 € rocznie, dla sklepu — 100–400 € i więcej (stan na 2026, sprawdzaj u dostawcy). Certyfikat SSL dla "
                           "zwykłej strony jest zwykle darmowy i wliczony w hosting. Poczta firmowa kosztuje od zera, jeśli skrzynki są w pakiecie hostingu, do kilku euro miesięcznie za użytkownika."),
                          ("h3", "Хостинг", "Hosting"),
                          ("p",
                          ...
                          ("p",
                           "Для лендінгу, візитки й більшості магазинів вистачає безкоштовного сертифіката, який хостинг видає й продовжує автоматично. Платний сертифікат потрібен рідко — "
                           "якщо провайдер наполегливо його пропонує малому бізнесу, спершу уточніть, чи є безкоштовний варіант.",
                           "Dla landingu, wizytówki i większości sklepów wystarczy darmowy certyfikat, który hosting wystawia i odnawia automatycznie. Płatny certyfikat jest potrzebny rzadko — "
                           "jeśli dostawca uparcie proponuje go małej firmie, najpierw zapytaj o darmową opcję."),
                          ("h3", "Пошта на домені", "Poczta firmowa"),
                          ("p",
              ...
              {"h2_uk": "Платні плагіни, план Webflow і сторонні сервіси",
               ...
               "blocks": [("p",
                           "Ця стаття витрат залежить від платформи. На WordPress це платні плагіни й теми з річною ліцензією, на Webflow — щомісячний план сайту, на чистому коді платних "
                           "ліцензій часто немає зовсім. Для візитки це може бути нуль, для магазину — від кількох десятків до кількох сотень євро на рік.",
                           "Ta pozycja zależy od platformy. Na WordPressie to płatne wtyczki i motywy z roczną licencją, na Webflow — miesięczny plan strony, a przy stronie napisanej w kodzie "
                           "płatnych licencji często nie ma wcale. Dla wizytówki może to być zero, dla sklepu — od kilkudziesięciu do kilkuset euro rocznie."),
                          ("ul",
                           [("<b>WordPress:</b> безкоштовна система, але окремі плагіни (форми, SEO, фільтри магазину, резервні копії) мають платні версії з річною ліцензією;",
                             "<b>WordPress:</b> sam system jest darmowy, ale część wtyczek (formularze, SEO, filtry w sklepie, kopie zapasowe) ma płatne wersje z roczną licencją;"),
                            ("<b>Webflow:</b> хостинг входить у план сайту. У травні 2026 Webflow оновив лінійку: орієнтовно $15/міс за Basic і $25/міс за Premium з CMS при оплаті за рік;",
                             "<b>Webflow:</b> hosting jest w planie strony. W maju 2026 Webflow zmienił ofertę: orientacyjnie 15 $/mies. za Basic i 25 $/mies. za Premium z CMS przy płatności rocznej;"),
                            ("<b>магазин:</b> додаються комісії платіжних систем і, за потреби, сервіси доставки чи інтеграції — їхні тарифи залежать від обсягу продажів;",
                             "<b>sklep:</b> dochodzą prowizje operatorów płatności i ewentualnie integracje z kurierami — ich stawki zależą od wielkości sprzedaży;"),
                            ("<b>сторонні сервіси:</b> онлайн-запис, чат, розсилки — часто мають безкоштовний тариф для старту.",
                             "<b>usługi zewnętrzne:</b> rezerwacje online, czat, newsletter — często mają darmowy pakiet na start.")]),
                          ("p",
                           "Приклад на Webflow — <a href=\"case-core-accounting\">сайт Core Accounting</a>: власник сам змінює тексти через CMS, тому потрібен план з CMS. Як платформа впливає на "
                           "витрати й зручність, ми порівняли в статті <a href=\"post-wordpress-webflow-kod\">WordPress, Webflow чи код</a>.",
                           "Przykład na Webflow to <a href=\"case-core-accounting\">strona Core Accounting</a>: właściciel sam zmienia treści w CMS, więc potrzebny jest plan z CMS. Jak platforma "
                           "wpływa na koszty i wygodę, porównaliśmy w artykule <a href=\"post-wordpress-webflow-kod\">WordPress, Webflow czy kod</a>.")]},
              {"h2_uk": "Скільки коштує утримання сайту на рік: таблиця-орієнтир",
               "h2_pl": "Ile kosztuje utrzymanie strony na rok: tabela orientacyjna",
               "blocks": [("p",
                          ...
                          ("table",
                           ...
                           [[("Домен", "Domena"), ("€10–45", "10–45 €"), ("€10–45", "10–45 €"), ("€10–45", "10–45 €")],
                            [("Хостинг або план Webflow", "Hosting lub plan Webflow"), ("€40–200", "40–200 €"), ("€40–200", "40–200 €"), ("€100–400+", "100–400+ €")],
              ...
              {"h2_uk": "Пастки: на чому переплачують і втрачають сайт",
               ...
               "blocks": [("p",
                           ...
                           "Najdroższe błędy w utrzymaniu strony to nie wysokie ceny, tylko niespodzianki: odnowienie kilka razy droższe niż pierwszy rok, „darmowa” domena powiązana z hostingiem "
                           "i domena zarejestrowana na agencję albo freelancera. Dwie pierwsze kosztują pieniądze, trzecia może kosztować całą stronę."),
                          ("h3", "Дешевий перший рік і дороге продовження", "Tani pierwszy rok i drogie odnowienie"),
                          ("p",
                          ...
                          ("p",
                           ...
                           "сайт, змінити пошту чи продовжити реєстрацію. Тому ми оформлюємо домен і хостинг на клієнта й після запуску передаємо всі доступи: сайт, домен, хостинг, CMS і сервіси.",
                           "Właścicielem domeny jest ten, kto figuruje jako abonent u rejestratora, a nie ten, kto zapłacił. Jeśli domena jest zarejestrowana na agencję lub freelancera, bez "
                           "ich udziału nie przeniesiesz strony, nie zmienisz poczty ani nie przedłużysz rejestracji. Dlatego domenę i hosting rejestrujemy na klienta, a po starcie "
                           "przekazujemy wszystkie dostępy: stronę, domenę, hosting, CMS i usługi."),
                          ("card",
                           "Перевірте прямо зараз: зайдіть у панель реєстратора й подивіться, на кого оформлено домен, до якої дати він оплачений і чи ввімкнене автопродовження. Якщо доступу "
                           "до панелі у вас немає, це перше, що варто виправити.",
              ...
              {"h2_uk": "Підтримка сайту: що ви отримуєте за від €20 на місяць",
               ...
               "blocks": [("p",
                          ...
                          ("p",
                           ...
                           "Aktualne ceny wykonania i opieki znajdziesz na stronie <a href=\"prices\">cennik stron</a>. Jeśli masz już stronę i nie masz pewności, czy z domeną i hostingiem "
                           "wszystko w porządku, <a href=\"contacts\">napisz do nas</a> — podpowiemy, co sprawdzić.")]},
              {"h2_uk": "Як зекономити на утриманні сайту без ризику",
               "h2_pl": "Jak zaoszczędzić na utrzymaniu strony bez ryzyka",
               "blocks": [("p",
 ...
 "faq": [["Скільки коштує утримання сайту на рік?",
         ...
         ["Скільки коштує домен для сайту?",
          ...
          "дивіться на ціну продовження. Дані станом на 2026, перевіряйте в реєстратора.",
          "Odnowienie domeny .pl kosztuje orientacyjnie 60–200 zł rocznie, zależnie od rejestratora; pierwszy rok bywa w promocji za kilka złotych. Domena .com to około 10–20 € rocznie. "
          "Dane według stanu na 2026 — przed zakupem sprawdź cenę odnowienia u rejestratora."],
         ["Домен .pl чи .com — що обрати?",
          "Domena .pl czy .com — co wybrać?",
          "Якщо клієнти в Польщі — .pl: до неї звикли, і Google краще розуміє країну сайту. Якщо працюєте на кілька країн — .com. Коли назва важлива для бренду, зареєструйте обидві зони й "
          "налаштуйте переадресацію на основну.",
          "Jeśli klienci są w Polsce — .pl: Polacy są do niej przyzwyczajeni, a Google łatwiej rozpoznaje kraj strony. Jeśli działasz w kilku krajach — .com. Gdy nazwa jest ważna dla "
          "marki, zarejestruj obie końcówki i ustaw przekierowanie na główną."],
         ["Чи входять домен і хостинг у ціну розробки?",
          "Czy domena i hosting są w cenie wykonania strony?",
          "Ні. Домен і хостинг оплачуються окремо, напряму провайдеру, і оформлюються на вас. Ми допомагаємо їх обрати й підключити — зазвичай це Hostinger або VPS, для сайтів на "
          "Webflow — Webflow hosting.",
          "Nie. Domenę i hosting opłacasz osobno, bezpośrednio u dostawcy, i są zarejestrowane na Ciebie. Pomagamy je wybrać i podłączyć — zwykle to Hostinger albo VPS, a dla stron "
          "na Webflow — hosting Webflow."],
         ["Чому домен треба оформлювати на себе?",
