...
'''+head(L('Хто ми','Kim jesteśmy'),L('Про нас','O nas'))+'''
        ...
        <div class="budget-intro reveal">
          <p class="budget-lead">'''+L('SHSTKV Digital — веб-студія з Вроцлава. Ми робимо сайти, магазини й Telegram-боти, які приносять бізнесу заявки, а не просто гарно виглядають. За нами понад 12 років досвіду й 35+ запущених проєктів у 6 країнах.','SHSTKV Digital to studio stron internetowych z Wrocławia. Tworzymy strony, sklepy i boty Telegram, które przynoszą firmom zapytania, a nie tylko dobrze wyglądają. Mamy ponad 12 lat doświadczenia i 35+ projektów w 6 krajach.')+'''</p>
