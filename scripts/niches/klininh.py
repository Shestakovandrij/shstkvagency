NICHE = {
    'key': 'klininh',
    'path_uk': '/sait-dlia-klininhovoi-kompanii/',
    'path_pl': '/pl/strona-internetowa-dla-firmy-sprzatajacej/',
    'name_uk': 'Клінінгові компанії',
    'name_pl': 'Firmy sprzątające',
    'card_sub_uk': 'Калькулятор прибирання, онлайн-замовлення з датою та сторінки під запити «прибирання + місто».',
    'card_sub_pl': 'Kalkulator sprzątania, zamówienie z wyborem terminu i podstrony pod frazy „sprzątanie + miasto”.',
    'img': 'assets/service-5.webp',
    'title_uk': 'Сайт для клінінгової компанії від €300 | SHSTKV Digital',
    'title_pl': 'Strona dla firmy sprzątającej od 300 € | SHSTKV Digital',
    'desc_uk': 'Сайт для клінінгової компанії від €300: калькулятор вартості прибирання, замовлення з датою, чекліст послуг і SEO під запити з назвою міста. Оцінка за 24 год.',
    'desc_pl': 'Strona dla firmy sprzątającej od 300 €: kalkulator ceny sprzątania, rezerwacja terminu, lista czynności i SEO pod „sprzątanie + miasto”. Wycena w 24 h.',
    ...
    'intro_title_uk': 'Сайт, з якого замовляють прибирання',
    'intro_title_pl': 'Strona, przez którą zamawia się sprzątanie',
    'incl_title_uk': 'Що входить',
    'incl_title_pl': 'Co zawiera',
    'lead_uk': 'Сайт для клінінгової компанії має відповісти на три питання клієнта: скільки це коштує, що саме приберуть і коли можуть приїхати. '
               'Людина, яка шукає прибирання квартири після ремонту чи мийку вікон, зазвичай відкриває кілька сайтів з телефона і пише туди, де ціну видно одразу, а не «за запитом». '
               'Тому ми будуємо сайт клінінгу навколо калькулятора вартості й короткої форми замовлення з вибором дати. '
               'Поруч ставимо чекліст «що входить», райони, де ви працюєте, і реальні відгуки з Google. '
    ...
    'pills': [['Прибирання квартир', 'Sprzątanie mieszkań'],
              ['Прибирання офісів', 'Sprzątanie biur'],
    ...
    'incl': [['Калькулятор вартості',
             ...
             ['Чекліст «що входить»',
              ...
              'Такий чекліст знімає більшість питань ще до замовлення і зменшує суперечки після прибирання. Поруч ставимо фото до і після.',
              'Dla każdego rodzaju sprzątania pokazujemy konkretną listę według pomieszczeń: kuchnia, łazienka, pokoje, przedpokój. Osobno piszemy, czego pakiet nie obejmuje i co kosztuje dodatkowo. '
              'Taka lista rozwiewa większość wątpliwości przed zamówieniem i ogranicza spory po sprzątaniu. Obok zdjęcia przed i po.'],
             ['Райони й локальне SEO',
              'Dzielnice i SEO lokalne',
              'Робимо окремі сторінки під запити «прибирання квартир + місто» і «прибирання після ремонту + місто», додаємо список районів, де ви працюєте, і зону виїзду. '
    ...
    'local_pills': [['Прайс і пакети', 'Cennik i pakiety'],
                    ...
                    ['Next.js', 'Next.js']],
    'cases': ['elart-cleaning', 'novalux', 'remico'],
    'faq': [['Скільки коштує сайт для клінінгової компанії?',
             'Ile kosztuje strona dla firmy sprzątającej?',
             'Лендінг для клінінгу коштує від €300 (тариф «Старт»), тариф «Про» з адмін-панеллю — €450, багатосторінковий сайт з окремими сторінками послуг і міст — від €450. '
             'Калькулятор вартості прибирання рахуємо окремо, бо формула залежить від вашого прайсу. Оцінку надсилаємо за 24 години. '
            ...
            ['Що потрібно від нас для старту?',
             ...
             'Дуже бажані власні фото команди та прибирань до і після: стокові фото в клінінгу довіри не додають. '
             'Якщо текстів немає, допоможемо зі структурою й формулюваннями.',
             'Potrzebny jest cennik albo chociaż zasada liczenia ceny (za metr, za pokój, dodatki), lista usług, miasta i dzielnice, w których działasz, dane kontaktowe i logo. '
             'Bardzo pomagają własne zdjęcia ekipy i efektów przed i po, bo zdjęcia ze stocków w tej branży nie budują zaufania. '
             'Jeśli nie masz tekstów, pomożemy ze strukturą i sformułowaniami.'],
            ['Чи можна зробити калькулятор вартості прибирання?',
             'Czy można dodać kalkulator ceny sprzątania?',
             'Так, калькулятор ми робимо під ваш прайс. Клієнт вказує метраж, кімнати, санвузли, тип прибирання (підтримувальне, генеральне, після ремонту) і додаткові послуги, а сума змінюється одразу. '
             'Можна показати «від» або точну ціну, додати мінімальне замовлення й доплату за виїзд за місто. Змінювати ставки потім можна без програміста.',
             'Tak, kalkulator przygotowujemy pod Twój cennik. Klient zaznacza metraż, pokoje, łazienki, rodzaj sprzątania (standardowe, generalne, po remoncie) i dodatki, a kwota zmienia się od razu. '
             'Można pokazać cenę „od” albo dokładną, dodać minimalną wartość zlecenia i dopłatę za dojazd poza miasto. Stawki zmienisz później bez programisty.'],
            ['Чи можна замовити прибирання на конкретну дату?',
             'Czy klient może zarezerwować konkretny termin?',
             'Так, у формі замовлення клієнт обирає дату й зручний час, а заявка з адресою, параметрами й сумою приходить вам у Telegram або на пошту. '
             'Для невеликої команди цього зазвичай досить: ви підтверджуєте термін повідомленням. Якщо графік щільний, можна підключити календар із зайнятими слотами. '
             'Оплату онлайн через BLIK чи Przelewy24 додаємо, коли це справді потрібно.',
             'Tak, w formularzu klient wybiera dzień i godzinę, a zgłoszenie z adresem, parametrami i kwotą trafia do Ciebie na Telegram lub e-mail. '
             'Dla małej ekipy to zwykle wystarczy: termin potwierdzasz wiadomością. Przy napiętym grafiku można podpiąć kalendarz z zajętymi terminami. '
             'Płatność online przez BLIK lub Przelewy24 dodajemy wtedy, gdy naprawdę jest potrzebna.'],
            ['Чи допоможете з пошуком у Google і на картах?',
             'Czy pomożecie z widocznością w Google i Mapach?',
             'Так, робимо базову SEO-оптимізацію, окремі сторінки під запити на кшталт «sprzątanie mieszkań Poznań» і список районів, а також допомагаємо налаштувати профіль компанії в Google. '
             'Топ Google не обіцяємо: позиції залежать від конкуренції в місті, відгуків і часу. '
             'Для прикладу подивіться, як ми працюємо з клієнтами з <a href="city-poznan">Познані</a>.',
             'Tak, robimy podstawową optymalizację SEO, osobne podstrony pod frazy typu „sprzątanie mieszkań Poznań” i listę dzielnic, a do tego pomagamy uporządkować Profil Firmy w Google. '
             'Nie obiecujemy pierwszego miejsca w Google: pozycja zależy od konkurencji w mieście, opinii i czasu. '
             'Zobacz, jak pracujemy z firmami z <a href="city-poznan">Poznania</a>.'],
            ...
            ['Що буде після запуску сайту?',
             ...
             'Ви отримуєте всі доступи: сайт, домен, хостинг і CMS, а в тарифах «Старт» і «Про» ще 30 днів підтримки. '
             'У тарифі «Про» ціни, послуги й фото змінюєте самі в адмін-панелі. Якщо не хочете цим займатися, є підтримка від €20 на місяць. '
